...
const Signin = () => {
  ...
  useEffect(() => {
    setHeader({
      ...
      subtitle: "Sign in your Nova account to access all Nova products",
    });
  }, [setHeader]);
    ...
    <>
      ...
      <form action="" className="flex flex-col gap-2">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <Link to={`/${BASE_PATHS.AUTH}/${AUTHS_PATHS.FORGOT_PASSWORD}`} className="text-sm text-[#3c41e9] underline">
